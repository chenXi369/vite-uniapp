      ...
      <view class="flex flex-1 flex-col justify-center px-6 py-12">
        <view class="mb-12 text-center">
          ...
          <view class="space-y-2">
            <text class="block text-3xl text-gray-900 font-bold font-custom">
              {{ appName }}
            </text>
            <text class="block text-base text-gray-600 font-custom">
              {{ appDescription }}
            </text>
          </view>
        </view>
        ...
        <view class="space-y-4">
          ...
          <view class="flex items-center px-2 space-x-2">
            ...
            <view class="mt-[1px] flex-1 leading-relaxed font-custom">
      ...
      <view class="px-6 pb-8">
        <view class="text-center space-y-3">
          <view class="mb-6 flex items-center space-x-4">
            ...
            <text class="px-3 text-xs text-gray-400 font-custom">
              技术支持
            </text>
            <view class="h-px flex-1 bg-gray-200"></view>
          </view>

          <view class="flex items-center justify-center space-x-2 font-custom">
